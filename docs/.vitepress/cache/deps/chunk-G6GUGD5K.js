...
var BaseReactiveHandler = class {
  ...
  get(target, key, receiver) {
    ...
    if (key === '__v_isReactive') {
      ...
      if (
        receiver === (isReadonly2 ? (shallow ? shallowReadonlyMap : readonlyMap) : shallow ? shallowReactiveMap : reactiveMap).get(target) || // receiver is not the reactive proxy, but has the same prototype
...
function trackRefValue(ref2) {
  if (shouldTrack && activeEffect) {
    ...
    trackEffect(
      activeEffect,
      ref2.dep || (ref2.dep = createDep(() => (ref2.dep = void 0), ref2 instanceof ComputedRefImpl ? ref2 : void 0)),
      true
        ? {
            target: ref2,
            type: 'get',
...
function propHasMismatch(el, key, clientValue, vnode) {
  ...
  if (key === 'class') {
    ...
    expected = toStyleMap(isString(clientValue) ? clientValue : stringifyStyle(normalizeStyle(clientValue)))
    if (vnode.dirs) {
